...
//        List<String> lines = this.busLinesService.mapStringToListString(response);
...
//                );
//            });
//        var cods = busLines.stream().filter(busLine -> busLine.getNome().equals("PAULINO AZURENHA/CASCATINHA/AZENHA (Carris)")).count();
